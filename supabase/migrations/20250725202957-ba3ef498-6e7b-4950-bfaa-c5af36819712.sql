-- CRITICAL SECURITY FIX: Enable RLS and Apply Comprehensive Policies (Corrected)
...
DROP POLICY IF EXISTS "Users can view their own profile and admins/trainers can view all" ON public.users;
DROP POLICY IF EXISTS "Users can update their own profile" ON public.users;
DROP POLICY IF EXISTS "Admins and trainers can view all users" ON public.users;
...
DROP POLICY IF EXISTS "Admins and trainers can view kullanicilar" ON public.kullanicilar;
DROP POLICY IF EXISTS "Admins can manage kullanicilar" ON public.kullanicilar;
...
DROP POLICY IF EXISTS "Trainers and admins can manage students" ON public.students;
...
CREATE POLICY "Trainers and admins can manage students"
